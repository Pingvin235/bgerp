...
public class LinkProcessCreateConfig
	extends Config
{
	private static final Logger log = Logger.getLogger( LinkProcessCreateConfig.class );
    ...
    public List<LinkProcessCreateConfigItem> getItemList( Connection con, Process process )
    {
    	...
    	//TODO: Подумать, может такой способ вызова убрать, т.к. не единообразно как-то.
