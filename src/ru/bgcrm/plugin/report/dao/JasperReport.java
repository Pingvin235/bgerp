...
public class JasperReport
{
	...
	public void addPrintQueueDocumentToOutputStream( List<Object[]> data, Queue queue, PrintType printType, OutputStream ostream )
		throws Exception
	{
		FastReportBuilder drb = new FastReportBuilder();
		drb.setTitle( "Очередь : " + queue.getTitle() )
		   .setSubtitle( "Дата создания отчета " + new SimpleDateFormat().format( new Date() ) )
		...
		//TODO: В дальнейшем сделать печать через JEXL выражения, как в HTML
		//RowExpressionConfig customConfig = queue.getConfigMap().getConfig( RowExpressionConfig.class );		
