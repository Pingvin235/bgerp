...
public class PrintQueueEventListener {
    ...
    public PrintQueueEventListener() {
        EventProcessor.subscribe(new EventListener<QueuePrintEvent>() {
            @Override
            public void notify(QueuePrintEvent e, ConnectionSet connectionSet) throws BGException {
                ...
                try {
                    ...
                    new JasperReport().addPrintQueueDocumentToOutputStream(event.getData(), event.getQueue(), printType, response.getOutputStream());
