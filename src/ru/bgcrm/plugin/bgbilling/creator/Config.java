    ...
    extends ru.bgcrm.util.Config
{
	...
	private static final Set<String> ALLOWED_IMPORT_PARAM_TYPES = new HashSet<String>( Arrays.asList( TYPE_ADDRESS, TYPE_TEXT, TYPE_PHONE, TYPE_DATE, TYPE_LIST, TYPE_EMAIL ) );
	    ...
	    throws BGException
	{
		...
		/*for( String token : setup.get( prefix + "phonePrefixRules", "" ).split( ";" ) )
		{
