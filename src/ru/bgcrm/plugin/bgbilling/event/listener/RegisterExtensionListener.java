    ...
    public RegisterExtensionListener() {
        EventProcessor.subscribe(new EventListener<RegisterExtensionFunctionsEvent>() {
            ...
            public void notify(RegisterExtensionFunctionsEvent e, ConnectionSet connectionSet) {
                ...
                // proc.registerExtensionFunction( new CommonContractExtensionFunction(
                // connectionSet.getConnection() ) );
                proc.registerExtensionFunction(
                        new ContractCardExtensionFunction(connectionSet.getConnection(), e.getUser()));
                proc.registerExtensionFunction(new ContractCardForUserExtensionFunction(connectionSet.getConnection()));
                // proc.registerExtensionFunction( new CustomerExtensionFunction(
                // connectionSet.getConnection(), e.getUser() ) );
            }
