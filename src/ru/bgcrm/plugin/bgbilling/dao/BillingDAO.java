...
public class BillingDAO
{
	...
	protected <K extends Service, S> S getWebService( Class<K> clazz, Class<S> serviceClass )
		throws BGException
	{
		...
		throws BGException
	{
		...
		try
		{
			...
			Service webService = Service.create( new URL( wsdlLocation ), new QName( annotation.targetNamespace(), annotation.name() ) );
	...
	protected void processWebServiceException( Exception e )
		throws BGException
	{
