...
public class BillDAO extends BillingModuleDAO {
    ...
    public BillDAO(User user, String billingId, int moduleId) throws BGException {
     ...
     */
    public Pair<List<IdTitle>, List<IdTitle>> getContractDocTypeList(int contractId, String type) throws BGException {
    ...
    public void contractDocTypeAdd(int contractId, String typeIds) throws BGException {
        Request req = new Request();
        req.setModule(BILL_MODULE_ID);
    ...
    public void contractDocTypeDelete(int contractId, String typeIds) throws BGException {
        Request req = new Request();
        req.setModule(BILL_MODULE_ID);
    ...
    public void searchBillList(int contractId, Pageable<Bill> searchResult) throws BGException {
        Request req = new Request();
        req.setModule(BILL_MODULE_ID);
    ...
    public void searchInvoiceList(int contractId, Pageable<Invoice> searchResult) throws BGException {
        Request req = new Request();
        req.setModule(BILL_MODULE_ID);
    ...
    public void setPayed(String ids, boolean value, Date date, BigDecimal summa, String comment) throws BGException {
        Request req = new Request();
        req.setModule(BILL_MODULE_ID);
    ...
    public byte[] getDocumentsPdf(String ids, String type) throws BGException {
        Request req = new Request();
        req.setModule(BILL_MODULE_ID);
