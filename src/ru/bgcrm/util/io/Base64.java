...
public class Base64 {
    ...
    /**
     * Calls {@link #encode(String, String)} with charset='UTF-8'. 
     */
     ...
     * @throws RuntimeException При любых ошибках фатальных.
     */
    ...
    /**
     * Calls {@link #decode(String, String)} with charset='UTF-8'.
     */
