...
import static ru.bgcrm.util.PatternFormatter.*;
...
public class AddressUtils
{
	...
	public static final String buildAddressValue( final ParameterAddressValue value, Connection con )
		throws BGException
	{
		return buildAddressValue( value, con, null );
	}
	
	public static final String buildAddressValue( final ParameterAddressValue value, Connection con, String formatName )
		throws BGException
	{
