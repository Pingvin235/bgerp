...
public class MailConfig
{
	...
	{
		return  
			Utils.notBlankString( email ) &&
			Utils.notBlankString( login ) &&
			Utils.notBlankString( pswd );		
	}
	...
	private static final String getOptionFromConfigs( ParameterMap paramMap, ParameterMap defaultParamMap, 
