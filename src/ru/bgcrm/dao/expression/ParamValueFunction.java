...
public class ParamValueFunction
{
	 ...
	 * @throws BGException
	 */
	public String getParamText( int paramId )
		throws BGException
	{
	 ...
	 * @throws BGException
	 */
	public Date getParamDate( int paramId )
    	throws BGException
    {
	 ...
	 * @throws BGException
	 */
	public Date getParamDateTime( int paramId )
    	throws BGException
    {
	 ...
	 * @throws BGException
	 */
	public String getParamPhoneNoFormat( int paramId )
		throws BGException
	{
		ParameterPhoneValue value = paramDao.getParamPhone( objectId, paramId );
