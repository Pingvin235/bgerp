    ...
    extends CommonDAO
{
	...
	public void searchAddressCountryList( SearchResult<AddressCountry> searchResult, String title )
	    throws SQLException
	{
	...
	public void searchAddressCityList( SearchResult<AddressCity> searchResult,
	                                   int countryId,
	                                   String title,
	                                   boolean loadCountryData,
	                                   Set<Integer> cityIdFilter )
	    throws SQLException
	{
		if( searchResult != null )
		{
	...
	public AddressCity getAddressCity( int id, boolean loadCountryData )
	    throws SQLException
	{
	...
	public void searchAddressAreaList( SearchResult<AddressItem> searchResult,
	                                   int cityId )
	    throws SQLException
	{
	...
	public AddressItem getAddressArea( int id, boolean loadCountryData, boolean loadCityData )
	    throws SQLException
	{
		return getAddressItem( TABLE_ADDRESS_AREA, id, loadCountryData, loadCityData );
	}

	public void searchAddressQuarterList( SearchResult<AddressItem> searchResult,
	                                      int cityId )
	    throws SQLException
	{
	...
	public AddressItem getAddressQuarter( int id, boolean loadCountryData, boolean loadCityData )
	    throws SQLException
	{
		return getAddressItem( TABLE_ADDRESS_QUARTER, id, loadCountryData, loadCityData );
	}

	public void searchAddressStreetList( SearchResult<AddressItem> searchResult,
	                                     int cityId )
	    throws SQLException
	{
	...
	public AddressItem getAddressStreet( int id, boolean loadCountryData, boolean loadCityData )
	    throws SQLException
	{
		return getAddressItem( TABLE_ADDRESS_STREET, id, loadCountryData, loadCityData );
	}

	private void searchAddressItemList( String tableName,
	                                    SearchResult<AddressItem> searchResult,
	                                    Set<Integer> cityIds,
	                                    String title,
	                                    boolean loadCountryData,
	                                    boolean loadCityData )
	...
	private AddressItem getAddressItem( String tableName, int id, boolean loadCountryData, boolean loadCityData )
	    throws SQLException
	{
	...
	public void searchAddressHouseList( SearchResult<AddressHouse> searchResult,
	                                    int streetId,
	                                    String housePrefix )
	    throws SQLException
	{
	...
	public AddressHouse getAddressHouse( int id,
	                                     boolean loadCountryData,
	                                     boolean loadCityData,
	                                     boolean loadStreetData )
	    throws BGException
	...
	public void updateAddressCountry( AddressCountry addressCountry )
	    throws BGException
	{
		try
		{
			if( addressCountry != null )
			{
				...
				new ConfigDAO( con, TABLE_ADDRESS_CONFIG ).updateConfigForRecord( TABLE_ADDRESS_COUNTRY, addressCountry.getId(), addressCountry.getConfig() );
			}
		}
		catch( SQLException e )
		{
	...
	public void deleteAddressCountry( int id )
	    throws BGException
	{
		try
		{
	...
	public void deleteAddressCity( int id )
	    throws BGException
	{
		try
		{
	...
	public PreparedStatement checkItem( int id, String table, String title )
	...
	public void updateAddressArea( AddressItem addressItem )
	    throws BGException
	{
		updateAddressItem( TABLE_ADDRESS_AREA, addressItem );
	}

	public void updateAddressQuarter( AddressItem addressItem )
	    throws BGException
	{
		updateAddressItem( TABLE_ADDRESS_QUARTER, addressItem );
	}

	public void updateAddressStreet( AddressItem addressItem )
	    throws BGException
	{
		updateAddressItem( TABLE_ADDRESS_STREET, addressItem );
	}

	public void deleteAddressArea( int id )
	    throws BGException
	{
		deleteAddressItem( TABLE_ADDRESS_AREA, "area_id", id );
	}

	public void deleteAddressQuarter( int id )
	    throws BGException
	{
		deleteAddressItem( TABLE_ADDRESS_QUARTER, "quarter_id", id );
	}

	public void deleteAddressStreet( int id )
	    throws BGException
	{
		deleteAddressItem( TABLE_ADDRESS_STREET, "street_id", id );
	}

	private void updateAddressItem( String tableName,
	...
	private void deleteAddressItem( String tableName, String columnName, int id )
	    throws BGException
	{
		try
		{
	...
	public void updateAddressHouse( AddressHouse addressHouse )
	    throws SQLException
	{
		if( addressHouse != null )
		{
	...
	public void deleteAddressHouse( int id )
	    throws BGException
	{
		try
		{
	...
	public static AddressHouse getAddressHouseFromRs( ResultSet rs, String prefix, int loadLevel )
	    throws SQLException
	{
	...
	public static AddressItem getAddressItemFromRs( ResultSet rs, String prefix )
	    throws SQLException
	{
	...
	public static AddressCountry getAddressCountryFromRs( ResultSet rs, String prefix )
	    throws SQLException
	{
	...
	public static AddressCity getAddressCityFromRs( ResultSet rs, String prefix )
	    throws SQLException
	{
	...
	public List<AddressCountry> getUpdatedCountries( long time, int[] countriesId )
	    throws SQLException
	{
	...
	public List<AddressCity> getUpdatedCities( long time, int[] citiesId )
	    throws SQLException
	{
	...
	public List<AddressHouse> getUpdatedHouses( long time, int[] citiesId )
	    throws SQLException
	{
	...
	private List<AddressItem> getUpdatedItems( String tableName, long time, int[] citiesId )
	    throws SQLException
	{
	...
	public List<AddressItem> getUpdatedAreas( long time, int[] citiesId )
	    throws SQLException
	{
		return getUpdatedItems( TABLE_ADDRESS_AREA, time, citiesId );
	}

	public List<AddressItem> getUpdatedQuarters( long time, int[] citiesId )
	    throws SQLException
	{
		return getUpdatedItems( TABLE_ADDRESS_QUARTER, time, citiesId );
	}

	public List<AddressItem> getUpdatedStreets( long time, int[] citiesId )
	    throws SQLException
	{
		return getUpdatedItems( TABLE_ADDRESS_STREET, time, citiesId );
	}

	public List<Integer> getCountryIdByCityId( int[] citiesId )
	    throws SQLException
	{
	 ...
	 * @return
	 */
	public List<AddressItem> getAddressStreetsBySubstring( String streetSubstring, List<Integer> cityIds )
	    throws SQLException
	{
	...
	public int getCityIdByAddress( String address )
	    throws SQLException
	{
		int cityId = -1;
	...
	public List<Integer> getHouseIdsByStreetAndHouse( int streetId, String house, List<Integer> cityIds )
	    throws SQLException
	{
	...
	/*
	 * Wrapper for address search functions
	 * @param parentAddressId ID of country | city | street
	 * @param addressTitle fragment of address object title
	 * @param addressType searched address object type: country | city | street | house
	 * @param loadCountryData
	 * @param loadCutyData
	 * @param loadStreetData
	 * @return search result or null if search failed
	 * @throws SQLException
	 
	public SearchResult<?> searchAddress( Integer parentAddressId,
										  String addressTitle,
										  String addressType,
										  Boolean loadCountryData,
										  Boolean loadCutyData,
										  Boolean loadStreetData )
		throws SQLException
	{
		if( addressType.equals( "country" ) )
		{
			...
			searchAddressCountryList( searchResult, "%" + addressTitle + "%" );
			return searchResult;
		}
		else if( addressType.equals( "city" ) )
		{
			SearchResult<AddressCity> searchResult = new SearchResult<AddressCity>();
			searchAddressCityList( searchResult, parentAddressId, "%" + addressTitle + "%", false );
			return searchResult;
		}
		else if( addressType.equals( "street" ) )
		{
			SearchResult<AddressItem> searchResult = new SearchResult<AddressItem>();
			searchAddressStreetList( searchResult, parentAddressId, "%" + addressTitle + "%", false, false );
			return searchResult;
		}
		else if( addressType.equals( "house" ) )
		{
			SearchResult<AddressHouse> searchResult = new SearchResult<AddressHouse>();
			searchAddressHouseList( searchResult, parentAddressId, addressTitle, true, false, false, false );
			return searchResult;
		}
		return null;
	}
