    ...
    extends CommonDAO
{
	...
	public List<ParameterGroup> getParameterGroupList( String object )
	    throws SQLException
	{
	...
	public ParameterGroup getParameterGroup( int parameterGroupId )
	    throws SQLException
	{
	...
	public Set<Integer> getParameterIdsForGroup( int parameterGroupId )
	    throws SQLException
	{
	...
	private void setParameterGroupData( ResultSet rs, ParameterGroup parameterGroup )
	    throws SQLException
	{
