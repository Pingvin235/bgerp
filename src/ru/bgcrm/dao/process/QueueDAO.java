	...
	extends CommonDAO
{
	...
	public void searchQueue( SearchResult<Queue> searchResult, Set<Integer> queueIds, String filter )
		throws SQLException
	{
	...
	public void updateQueue( Queue queue, int user )
		throws BGException
	{
		try
		{
			...
			if( queue.getId() <= 0 )
			{
				...
				ps = con.prepareStatement( "INSERT INTO queue SET title=?, config=?, " + LastModifyDAO.LAST_MODIFY_COLUMNS, PreparedStatement.RETURN_GENERATED_KEYS );
	...
	public Set<Integer> getQueueProcessTypeIds( int id )
		throws BGException
	{
		return getIds( TABLE_QUEUE_PROCESS_TYPE, "queue_id", "type_id", id );
	}

	private Queue getQueueFromRs( ResultSet rs )
		throws SQLException
	{
	...
	public QueueStat getQueueStat( Queue queue, String userIds )
		throws SQLException
	{
	...
	public List<QueueProcessStat> getQueueProcessStat( Queue queue )
		throws SQLException
	{
	...
	public List<QueueUserStat> getQueueUserStat( Queue queue, String userIds )
		throws SQLException
	{
