    ...
    extends CommonDAO
{
	...
	public void changeStatus( Process process, ProcessType type, StatusChange change )
	    throws BGException
	{
		try
		{
			...
			ProcessDAO processDAO = new ProcessDAO( con, true, change.getUserId() );
			...
			String query =
				"UPDATE " + TABLE_PROCESS_STATUS + " SET last=0 WHERE process_id=? AND status_id=? AND last";
			...
			query =
				"INSERT INTO " + TABLE_PROCESS_STATUS + " (process_id, dt, user_id, status_id, comment) " +
				"VALUES (?, ?, ?, ?, ?)";
	...
	public void searchProcessStatus( SearchResult<StatusChange> searchResult, int processId, Set<Integer> statusIds )
	    throws BGException
	{
		try
		{
	...
	public static StatusChange getProcessStatusFromRs( ResultSet rs )
		throws SQLException
	{
		return getProcessStatusFromRs( rs, "status_change." );
	}

	public static StatusChange getProcessStatusFromRs( ResultSet rs, String prefix )
	    throws SQLException
	{
