...
public class Scheduler extends Thread {
	private static class TaskConfig {
		...
		public TaskConfig(ParameterMap config) throws BGException {
			...
			log.info("Class: " + clazz.getName() + "; dw: " + daysOfWeek + "; hours: " + hours + "; minutes: " + minutes
					+ "; enable: " + enable);
		}
	...
	private final ThreadPoolExecutor pool = new ThreadPoolExecutor(5, 5, 0L, TimeUnit.MILLISECONDS,
