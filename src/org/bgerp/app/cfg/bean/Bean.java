...
public class Bean {
    ...
    public static final void loadBeanClasses() {
        ...
        var r = classes();
        for (var clazz : r.getTypesAnnotatedWith(org.bgerp.app.cfg.bean.annotation.Bean.class, false)) {
            ...
            var an = clazz.getDeclaredAnnotation(org.bgerp.app.cfg.bean.annotation.Bean.class);
            if (an != null)
