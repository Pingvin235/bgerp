...
<html:form action="/admin/user" styleId="${uiid}" styleClass="in-mr1">
	...
	<ui:input-text name="filter" onChange="$$.ajax.loadContent(this)" placeholder="${l.l('Filter')}" size="40" value="${form.param['filter']}" title="${l.l('Filter by ID, title, configuration')}"/>
...
<shell:title text="${l.l('User Groups')}"/>
<shell:state/>