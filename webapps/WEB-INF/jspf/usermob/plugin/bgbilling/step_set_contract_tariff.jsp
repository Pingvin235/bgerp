...
<html:form styleId="${uiid}" action="/user/plugin/bgbilling/proto/contractTariff" style="width: 100%;">
	...
	<div class="in-table-cell">
		...
		<button class="ml1 btn-white" type="button" onClick="if (this.form.tariffPlanId.value > 0 && sendAJAXCommand(formUrl(this.form))) {${reopenProcessEditorCode}}">Выбрать</button>
	</div>
</html:form>