...
<div class="in-table-cell">
	<form action="/user/plugin/bgbilling/proto/contract.do">
		...
		<ui:combo-single name="value" value="${frd.contractInfo.mode}" prefixText="Режим (изменить):" widthTextValue="100px"
			onChange="$$.ajax.post(this.form).done(() => $$.ajax.load('${form.requestUrl}', $('#${uiid}').parent()))">
