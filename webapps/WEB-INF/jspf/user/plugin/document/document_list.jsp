...
<div class="in-table-cell">
		...
		<c:if test="${not empty patternList}">
			<div style="width: 100%;">
				...
				<c:set var="onChangeCode">
					...
					{
						$$.ajax.load('${form.requestURI}?method=additionalParameters&scope=${form.param.scope}&patternId=' + $selected.val(), $('#${dynamParamDivUiid}'));
	...
	<p:check action="/user/plugin/document/document:uploadDocument">
