...
<html:form action="/user/process" styleClass="mb05" styleId="${uiid}">
	...
	<div class="in-mb05-all">
		...
		<ui:combo-single name="open" value="${form.param.open}" onChange="${reloadCommand}"
		...
		<ui:combo-single name="typeId" list="${frd.types}" value="${form.param.typeId}" onChange="${reloadCommand}"
