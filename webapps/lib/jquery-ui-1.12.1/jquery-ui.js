				...
				for ( dRow = 0; dRow < numRows; dRow++ ) { // create date picker rows
					...
					for ( dow = 0; dow < 7; dow++ ) { // create date picker days
						...
						tbody += "<td id='ui-datepicker-calendar-day-" + (printDate.getMonth() + 1) + "-" + printDate.getDate() + "' class='" +
							...
							// PATCH BGERP, onclick='return false;' to prevent corrupting browser URL's fragment
							"' href='#' onclick='return false;'>" + printDate.getDate() + "</a>" ) ) + "</td>"; // display selectable date
...
$.widget( "ui.tabs", {
	...
	options: {
		...
		beforeLoad: null,
		load: null,
		// PATCH ADDITION BGERP, refresh button
		refreshButton: false
	},
