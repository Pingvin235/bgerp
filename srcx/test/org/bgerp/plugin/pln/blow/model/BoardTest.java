...
public class BoardTest {
    ...
    public void testGetRoot() throws Exception{
        ...
        List<Pair<ru.bgcrm.model.process.Process, Map<String, Object>>> processes = Lists
                .newArrayList(new Pair<>(p1, null), new Pair<>(p2, null), new Pair<>(p3, null), new Pair<>(p4, null));
        List<CommonObjectLink> links = Lists.newArrayList(new Made(p1.getId(), p2.getId()),
                new Made(p1.getId(), p3.getId()));
