...
public class InstallerModulesTest {
    ...
    public void testLoadRemoteFiles() {
        ...
        Assert.assertEquals("https://bgerp.org/version/3.0/update_3.0_1373.zip", update.url.toString());
        ...
        Assert.assertEquals("https://bgerp.org/version/3.0/update_lib_3.0_77.zip", updateLib.url.toString());
