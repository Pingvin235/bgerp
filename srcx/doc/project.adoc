...
link:../../src/ru/bgcrm/struts/action/MessageAction.java#L229-L229[ru.bgcrm.struts.action.MessageAction]
...
Восстановление:
[snippet, from="pu", to="}", remove-leading="    "]
link:../../src/ru/bgcrm/struts/action/MessageAction.java#L276-L288[ru.bgcrm.struts.action.MessageAction]
