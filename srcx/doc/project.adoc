...
`action.xml` with <<action-permission, permission tree>> for <<kernel/interface.adoc#user, user>> interface actions have to be located in *PLUGIN_PACKAGE*.
...
link:../../src/org/bgerp/action/admin/RunAction.java#L15-L17[org.bgerp.action.admin.RunAction]
...
link:../../src/org/bgerp/action/admin/RunAction.java#L27-L56[org.bgerp.action.admin.RunAction]
