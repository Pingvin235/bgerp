...
link:../../src/ru/bgcrm/plugin/slack/Plugin.java#L29-L31[ru.bgcrm.plugin.slack.Plugin]
...
[snippet, from="fun", to="}"]
link:../../webapps/js/kernel.ajax.js#L453-L457[webapps/js/kernel.ajax.js]
...
link:../../src/ru/bgcrm/struts/action/MessageAction.java#L191-L191[ru.bgcrm.struts.action.MessageAction]
...
* Use PRIMARY key only for auto incremented ID, otherwise prefer named UNIQUE key.
...
link:../../src/ru/bgcrm/struts/action/MessageAction.java#L64-L64[ru.bgcrm.struts.action.MessageAction]

Restoring a value:
[snippet, from="pu", to="}", remove-leading="    "]
link:../../src/ru/bgcrm/struts/action/MessageAction.java#L415-L423[ru.bgcrm.struts.action.MessageAction]
