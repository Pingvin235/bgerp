...
During <<project/workflow.adoc#, changes>> testing, code improvements will be tested as well.
...
[[env-console]]
===== Shell
System of <<project/workflow.adoc#build, build and publish>> is written on Bash scripts and uses GNU utilities, you can use the following when using Windows:
[square]
...
[[checkout-contrib]]
==== Contributors
For project's contributors, internal repo with <<project/workflow.adoc#change, branches>>:
[source]
----
...
. Be cautious when combining file formatting with making <<project/workflow.adoc#change, changes>> - this can significantly complicate analysis down the road.
...
[square]
* *Buildship Gradle* - <<project/workflow.adoc#build, Gradle>> support;
* *AsciiDoctor* -  <<project/workflow.adoc#doc, documentation>> editor;
* *MoreUnit* - convenient plugin to work with <<project/workflow.adoc#unit-test, unit-tests>>.
...
* *build* - files related to <<project/workflow.adoc#build, build>>;
...
* *srcx* - <<project/workflow.adoc#doc, documentation>>, <<project/workflow.adoc#unit-test, unit-tests>>, <<project/workflow.adoc#integration-test, integration tests>>, build utilities sources;
...
External libraries are supplied with a separate <<project/workflow.adoc#build-release, update package>>.
...
Existence of the file causes build library update package during <<project/workflow.adoc#build-release, release build>>.
...
<<kernel/db.adoc#, DB Structure>> is documented in the common <<project/workflow.adoc#doc, process>>, simultaneously with making changes.
...
link:../../src/ru/bgcrm/struts/action/MessageAction.java#L192-L192[ru.bgcrm.struts.action.MessageAction]
...
link:../../src/ru/bgcrm/struts/action/MessageAction.java#L403-L403[ru.bgcrm.struts.action.MessageAction]

Restoring a value:
[snippet, from="pu", to="}", remove-leading="    "]
link:../../src/ru/bgcrm/struts/action/MessageAction.java#L428-L436[ru.bgcrm.struts.action.MessageAction]
...
link:../../webapps/js/kernel.shell.js#L433-L434[webapps/js/kernel.shell.js]
