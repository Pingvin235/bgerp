...
[source]
----
git clone https://git.pzdc.de/bgerp/bgerp.git BGERP
----
...
link:../../src/org/bgerp/action/admin/RunAction.java#L20-L24[org.bgerp.action.admin.RunAction]
...
link:../../src/org/bgerp/action/admin/RunAction.java#L26-L55[org.bgerp.action.admin.RunAction]
...
[snippet, from="fun", to="}"]
link:../../webapps/js/kernel.ajax.js#L413-L417[webapps/js/kernel.ajax.js]
...
link:../../webapps/js/kernel.shell.js#L380-L381[webapps/js/kernel.shell.js]
...
[source, bash]
----
bash -c "./gradlew clean buildClean buildUpdate"
----
or:
[source, bash]
----
