...
<<build-erp, Release is published>> periodically from the *master* branch.
...
CAUTION: Be sure that <<test-integration, Integration tests>> are suscessully done on *master* to provide data for Demo DB.
