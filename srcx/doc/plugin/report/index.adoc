...
You can find samples of JSP reports link:https://git.bgerp.org/bgerp/custom/bgerp-custom/-/tree/master/webapps/WEB-INF/plugin/report[here]
...
This migration mainly comes down to replacing calls of no more supported JSP functions to method calls of objects, similar like for <<../../kernel/extension.adoc#jexl-standard-context, Standard JEXL Context>>.
