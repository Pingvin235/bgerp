...
Изменения в документации, не отражённые в link:https://bgerp.ru/changes.txt[ChangeLog].

Исправления, уточнения, примеры и рекомендации.
Вся документация актуальна для последней сборки BGERP.
Лог изменений публикуется в обратном хронологическом порядке.

NOTE: Замечания и предложения просьба писать в link:https://forum.bitel.ru/viewtopic.php?t=9604[тему] форума.
...
* <<project.adoc#dev, 29.10.2019>> Информация для разработчиков об обработке запросов, примеры кода.
...
* <<kernel/install.adoc#install-linux, 25.06.2019>> Генератор документации вынесен во внешний link:http://pzdcdoc.org[проект PzdcDoc]. Улучшенная навигация по подразделам.
...
* <<kernel/db.adoc#_n_message, 10.03.2019>> Описание таблицы n_message.
...
* <<kernel/install.adoc#install-linux, 25.12.2018>> Обновлена инструкция по установке.
...
// Возможно впоследствии и лог изменений будет перенесён сюда.
