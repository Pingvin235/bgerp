...
----
bash build/docker/files.sh && docker build build/docker -t bgerp/bgerp
----

Test the created image with <<../kernel/install.adoc#method-docker, installation>> it in local Docker.
