...
link:../../../src/org/bgerp/action/MessageAction.java#L496-L496[org.bgerp.action.MessageAction]

Restoring a value:
[snippet, from="pu", to="}", remove-leading="    "]
link:../../../src/org/bgerp/action/MessageAction.java#L528-L535[org.bgerp.action.MessageAction]

Saving and restoring a value at once:
[snippet, from="public A", to=");", remove-leading="    "]
link:../../../src/ru/bgcrm/struts/action/ProcessLinkAction.java#L48-L51[ru.bgcrm.struts.action.ProcessLinkAction]
...
link:../../../src/org/bgerp/action/ProcessLinkProcessAction.java#L58-L66[org.bgerp.action.ProcessLinkProcessAction]
