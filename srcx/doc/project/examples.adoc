...
link:../../../src/org/bgerp/action/MessageAction.java#L501-L501[org.bgerp.action.MessageAction]

Restoring the value:
[snippet, from="pu", to=");", remove-leading="    "]
link:../../../src/org/bgerp/action/MessageAction.java#L498-L501[org.bgerp.action.MessageAction]
