...
link:../../../src/org/bgerp/action/MessageAction.java#L498-L498[org.bgerp.action.MessageAction]

Restoring a value:
[snippet, from="pu", to="}", remove-leading="    "]
link:../../../src/org/bgerp/action/MessageAction.java#L530-L537[org.bgerp.action.MessageAction]
