...
link:../../../src/ru/bgcrm/struts/action/MessageAction.java#L462-L462[ru.bgcrm.struts.action.MessageAction]

Restoring a value:
[snippet, from="pu", to="}", remove-leading="    "]
link:../../../src/ru/bgcrm/struts/action/MessageAction.java#L492-L499[ru.bgcrm.struts.action.MessageAction]
...
link:../../../src/org/bgerp/action/ProcessLinkProcessAction.java#L44-L52[org.bgerp.action.ProcessLinkProcessAction]
...
Java action:
[snippet, from="Pag", to="));", remove-leading="        "]
link:../../../src/org/bgerp/action/ProcessLinkProcessAction.java#L67-L69[org.bgerp.action.ProcessLinkProcessAction]

[[code-upload-file]]
=== File upload
JSP page:
[snippet, from="<c:set", to="script>", remove-leading="				"]
link:../../../webapps/WEB-INF/jspf/admin/license/license.jsp#L25-L36[webapps/WEB-INF/jspf/admin/license/license.jsp]
...
link:../../../webapps/WEB-INF/jspf/admin/process/type/properties.jsp#L185-L190[webapps/WEB-INF/jspf/admin/process/type/properties.jsp]
...
link:../../../webapps/WEB-INF/jspf/admin/user/user/update.jsp#L168-L173[webapps/WEB-INF/jspf/admin/user/user/update.jsp]
...
link:../../../webapps/WEB-INF/jspf/user/process/queue/filter.jsp#L904-L904[webapps/WEB-INF/jspf/user/process/queue/filter.jsp]
