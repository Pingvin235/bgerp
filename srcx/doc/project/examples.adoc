...
link:../../../src/org/bgerp/action/MessageAction.java#L505-L505[org.bgerp.action.MessageAction]

Restoring a value:
[snippet, from="pu", to="}", remove-leading="    "]
link:../../../src/org/bgerp/action/MessageAction.java#L537-L544[org.bgerp.action.MessageAction]
