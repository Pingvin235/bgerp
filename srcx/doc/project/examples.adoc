...
link:../../../src/ru/bgcrm/struts/action/MessageAction.java#L506-L506[ru.bgcrm.struts.action.MessageAction]

Restoring a value:
[snippet, from="pu", to="}", remove-leading="    "]
link:../../../src/ru/bgcrm/struts/action/MessageAction.java#L536-L543[ru.bgcrm.struts.action.MessageAction]
...
link:../../../webapps/js/kernel.shell.js#L450-L451[webapps/js/kernel.shell.js]
