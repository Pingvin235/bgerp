...
link:../../../src/org/bgerp/action/MessageAction.java#L510-L510[org.bgerp.action.MessageAction]

Restoring a value:
[snippet, from="pu", to="}", remove-leading="    "]
link:../../../src/org/bgerp/action/MessageAction.java#L542-L549[org.bgerp.action.MessageAction]
