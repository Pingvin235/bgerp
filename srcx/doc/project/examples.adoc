...
link:../../../src/ru/bgcrm/struts/action/MessageAction.java#L454-L454[ru.bgcrm.struts.action.MessageAction]

Restoring a value:
[snippet, from="pu", to="}", remove-leading="    "]
link:../../../src/ru/bgcrm/struts/action/MessageAction.java#L484-L491[ru.bgcrm.struts.action.MessageAction]
