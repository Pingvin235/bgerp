...
----
docker pull bgerp/bgerp && docker run -d --name bgerp-demo --restart unless-stopped -p 3388:3306 bgerp/bgerp && docker logs --follow bgerp-demo
----

Make sure, that the container is running, wait the messages:
----
Running BGERP
...
docker cp bgerp-demo:/opt/bgerp/lic.data lic.data &&
...
link:../../../src/ru/bgcrm/plugin/slack/Plugin.java#L36-L38[ru.bgcrm.plugin.slack.Plugin]
...
link:../../../src/org/bgerp/plugin/kernel/db.sql#L440-L440[src/org/bgerp/plugin/kernel/db.sql]
...
link:../../../src/org/bgerp/plugin/kernel/db.sql#L389-L389[src/org/bgerp/plugin/kernel/db.sql]
...
link:../../../src/org/bgerp/plugin/kernel/action.xml#L143-L144[org/bgerp/plugin/kernel/action.xml]
...
link:../../../webapps/WEB-INF/jspf/user/message/process_message_list.jsp#L210-L210[webapps/WEB-INF/jspf/user/message/process_message_list.jsp]
...
[snippet, from="fun", to="}"]
link:../../../webapps/js/kernel.ajax.js#L580-L584[webapps/js/kernel.ajax.js]
...
link:../../../src/ru/bgcrm/struts/action/MessageAction.java#L231-L231[ru.bgcrm.struts.action.MessageAction]
...
link:../../../src/org/bgerp/util/lic/License.java#L153-L156[org.bgerp.util.lic.License]

[snippet, from="final v", to="es\");", remove-leading="            "]
link:../../../src/ru/bgcrm/cache/UserNewsCache.java#L98-L102[ru.bgcrm.cache.UserNewsCache]
