...
link:../../../src/org/bgerp/plugin/kernel/db.sql#L434-L434[src/org/bgerp/plugin/kernel/db.sql]
...
link:../../../src/org/bgerp/plugin/kernel/db.sql#L383-L383[src/org/bgerp/plugin/kernel/db.sql]
