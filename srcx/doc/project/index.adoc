...
link:../../../webapps/WEB-INF/jspf/admin/config/list.jsp#L88-L89[webapps/WEB-INF/jspf/admin/config/list.jsp]
...
link:../../../webapps/WEB-INF/jspf/admin/config/list.jsp#L64-L76[webapps/WEB-INF/jspf/admin/config/list.jsp]

Action:
[snippet, from="public", to="}", remove-leading="    "]
link:../../../src/ru/bgcrm/struts/action/admin/ConfigAction.java#L153-L160[src/ru/bgcrm/struts/action/admin/ConfigAction.java]
...
link:../../../webapps/WEB-INF/jspf/user/process/queue/filter.jsp#L911-L911[webapps/WEB-INF/jspf/user/process/queue/filter.jsp]
