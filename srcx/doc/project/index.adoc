...
link:../../../src/ru/bgcrm/struts/action/MessageAction.java#L425-L425[ru.bgcrm.struts.action.MessageAction]

Restoring a value:
[snippet, from="pu", to="}", remove-leading="    "]
link:../../../src/ru/bgcrm/struts/action/MessageAction.java#L455-L463[ru.bgcrm.struts.action.MessageAction]
