...
link:../../../src/org/bgerp/plugin/kernel/db.sql#L419-L419[src/org/bgerp/plugin/kernel/db.sql]
...
link:../../../src/org/bgerp/plugin/kernel/db.sql#L367-L367[src/org/bgerp/plugin/kernel/db.sql]
