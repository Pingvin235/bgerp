...
link:../../../src/org/bgerp/plugin/kernel/db.sql#L415-L415[src/org/bgerp/plugin/kernel/db.sql]
...
link:../../../src/org/bgerp/plugin/kernel/db.sql#L363-L363[src/org/bgerp/plugin/kernel/db.sql]
