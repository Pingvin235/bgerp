...
* 2 whitespaces - SQL <<plugin-db, scripts>> (will be unified in the future);
* tabs - XML, HTML, JS, JSP, Dockerfile.
...
[square]
* *Buildship Gradle* - <<workflow.adoc#build, Gradle>> support;
...
Restoring a value:
[snippet, from="pu", to="}", remove-leading="    "]
link:../../../src/ru/bgcrm/struts/action/MessageAction.java#L433-L441[ru.bgcrm.struts.action.MessageAction]
