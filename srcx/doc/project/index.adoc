...
link:../../../src/org/bgerp/plugin/kernel/db.sql#L443-L443[src/org/bgerp/plugin/kernel/db.sql]
...
link:../../../src/org/bgerp/plugin/kernel/db.sql#L392-L392[src/org/bgerp/plugin/kernel/db.sql]
