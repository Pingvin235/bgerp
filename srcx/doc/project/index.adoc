...
link:../../../src/org/bgerp/plugin/kernel/db.sql#L303-L303[src/org/bgerp/plugin/kernel/db.sql]
...
link:../../../src/org/bgerp/plugin/kernel/db.sql#L251-L251[src/org/bgerp/plugin/kernel/db.sql]
