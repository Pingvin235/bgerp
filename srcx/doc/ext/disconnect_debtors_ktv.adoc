...
image::_res/ktv_debt/i0154.png[width="600px"]

Очередь "Отключение должника":

image::_res/ktv_debt/i0155.png[width="600px"]
...
image::_res/ktv_debt/i0156.png[width="600px"]

Процес "Должник"

image::_res/ktv_debt/i0157.png[width="600px"]
...
image::_res/ktv_debt/i0158.png[width="600px"]

Доп действия в очереди

image::_res/ktv_debt/i0159.png[width="600px"]

Вид бланка

image::_res/ktv_debt/i0160.png[width="600px"]
