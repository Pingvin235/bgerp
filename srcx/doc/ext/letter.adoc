...
Процесс может быть создан в контрагенте, конфигурация <<../kernel/process/index.adoc#type-config-reference, описания>> выводит дату отправки и тип письма в списке.
