...
[[custom-workflow]]
=== GIT Workflow
Content of the directory may be stored using GIT and developed in normal <<../project/index.adoc#ide, IDE>>.
...
Use the following commands for updatining your fork repo to the actual state of *bgerp-custom* repo.
[source]
----
