...
[[dyn]]
== Dynamic code
CAUTION: Due to the many classloader related problems the Dynamic code approach will be in future replaced to the <<custom-jar, custom JAR>>.
...
or you may change the marker string in configuration parameter *server.jar.marker*.
