...
Перечень областей:
[square]
* *customer* - <<usage-link-process, вкладка>> *Процессы* контрагента;
...
image::_res/linked_process/add_existing.png[]
...
image::_res/linked_process/create_and_link.png[width="800"]
