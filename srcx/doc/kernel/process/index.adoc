...
* *pp* or *processParam* - object of class javadoc:org.bgerp.dao.expression.ParamExpressionObject[], process parameters;
* *pl* or *processLink* - object of class javadoc:org.bgerp.dao.expression.ProcessLinkExpressionObject[], process links.
...
[square]
* *processParam* - object of class javadoc:org.bgerp.dao.expression.ParamExpressionObject[], process parameters.
...
В конфигурации очереди могут быть определены столбцы и <<queue.adoc#setup-sort, сортировки>> с явным значением *value*.
