...
* *<MESSAGE_TAG_IDS>* - comma separated <<message.adoc#message-tag, message tag>> IDs to be shown, * - show all tags;
...
----
/-----\              /-----\                              /-----\
|c4F3 | Add / create |c666 | DB action (select or change) |cEEE | Other actions
\-----/              \-----/                              \-----/
----

In the documentation UI schemes are show using special notation, <<install.adoc#installer-iface, example>>.
