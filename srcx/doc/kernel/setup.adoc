...
NOTE: In former versions file bodies were stored as a flat list, that may be changed <<run, running>> javadoc:org.bgerp.task.MoveToSubDirs[] class.
...
image::_res/setup/param/address_view.png[width="800px"]
...
image::_res/setup/param/address_editor.png[width="800px"]

The street search may be performed over multiple substrings as well.

image::_res/setup/param/address_editor_1.png[width="800px"]
...
image::_res/setup/param/tree.png[width="800px"]
...
image::_res/setup/param/treecount.png[width="800px"]
...
image::_res/setup/param/treecount_editor.png[]
...
image::_res/setup/status/db_trace.png[width="800px"]

Down on the page is placed App restart button and tables with logs.

image::_res/setup/status/restart_logs.png[width="800px"]

[[status-warn]]
IMPORTANT: Size of *bgerp.warn.log* must be zero, check messages there case and perform required fixes if its not.
...
Scheduler allows periodically run Java classes, which extend javadoc:org.bgerp.app.scheduler.Task[].
To configure scheduler tasks add the following blocks to server configuration:
[source]
----
...
image::_res/scheduler.png[width="800px"]
